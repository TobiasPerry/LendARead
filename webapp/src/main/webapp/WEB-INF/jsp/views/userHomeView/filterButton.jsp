...
<div class="d-inline-flex">
    ...
    <form action="${filterUrl}" method="get">
        ...
        <button type="submit" data-bs-toggle="tooltip" data-bs-placement="top" title="<spring:message code='${param.title}'/>" class="btn btn-primary filter-button ${param.filter == param.filterValue && param.table == param.table ? 'filter-button-selected' : ''}">
