    ...
    <div class="container">
        ...
        <div class="container-row-wrapped" style="background-color: #D0DCD0; border-radius: 20px; padding: 20px;">
                ...
                <div class="info-container m-3" style="max-width: 300px; min-width: 300px; min-height: 300px">
                    ...
                    <form:form action="${editUrl}" method="post" modelAttribute="locationForm">
                        <div class="field-group">
                            <form:input path="name" id="name${location.id}" class="form-control" disabled="true"
                                        value="${location.name}"
                                        style="font-size: 1.5em; font-weight: bold; border: none; outline: none; background-color: transparent;"/>
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="field">
                                    ...
                                    <form:input path="locality" id="locality${location.id}" class="form-control"
                                                disabled="true" value="${location.locality}"/>
                                    <c:if test="${location.id == locationIdError}">
                                ...
                                <div class="field">
                                    ...
                                    <form:input path="province" id="province${location.id}" class="form-control"
                                                disabled="true" value="${location.province}"/>
                                    <c:if test="${location.id == locationIdError}">
                            ...
                            <div class="d-flex justify-content-between">
                                <div class="field">
                                    ...
                                    <form:input path="country" id="country${location.id}" class="form-control"
                                                disabled="true" value="${location.country}"/>
                                    <c:if test="${location.id == locationIdError}">
                                ...
                                <div class="field">
                                    ...
                                    <form:input path="zipcode" id="zipcode${location.id}" class="form-control"
                                                disabled="true" value="${location.zipcode}"/>
                                    <c:if test="${location.id == locationIdError}">
                    ...
                    <div class="mt-3 form-button-container d-flex justify-content-around">
                        ...
                        <c:if test="${locations.size() > 1}">
                            <form:form action="${deleteUrl}" method="post" class="d-inline-block">

                                <input type="hidden" name="id" value="${location.id == null ? -1 : location.id}">
                                <div style="height: 43px">
                                    <button type="submit" style="min-width: 100%;height: 100%;width: 50%;"
                                            class="btn-red delete-location">
                        ...
                        <div style="width: 50%">
                            <button type="button" class="edit-button btn-green mx-1"
                                    style="min-width: 100%;border-width: 0 ">Edit
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <c:if test="${locations.size() <= 5 }">
                <div class="info-container m-3 add-new-location btn-icon add-button"
                     style="max-width: 300px; min-width: 300px; height: 300px;">
