...
private final MessageSource messageSource;
    ...
    public Response toResponse(AssetNotExistException e) {
        return Response.status(Response.Status.BAD_REQUEST).entity(ErrorDTO.fromError(messageSource.getMessage("exception.assetNotExist", null, LocaleContextHolder.getLocale()),null)).build();
        }
}