...
public class AssetInstanceFactory {
    public static AssetInstanceImpl createAssetInstance(int id, BookImpl book, PhysicalCondition physicalCondition, UserImpl user, LocationImpl location, int photoId, AssetState state, int maxDaysLending) {
