...
public class AssetInstanceFactory {
    public static AssetInstanceImpl createAssetInstance(int id, BookImpl book, PhysicalCondition physicalCondition, UserImpl user, LocationImpl location, ImageImpl photoId, AssetState state, int maxDaysLending,String description) {
        return new AssetInstanceImpl(id,book, physicalCondition, user, location,photoId,state, maxDaysLending,description);
    }
