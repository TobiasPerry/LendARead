...
public class AssetInstanceFactory {
    public static AssetInstance createAssetInstance(int id, BookImpl book, PhysicalCondition physicalCondition, UserImpl user, LocationImpl location, int photoId, AssetState state, int maxDaysLending) {
